...
TASK_COUNTER = Counter(
    "celery_task_total", "Total number of tasks", ["task_name", "status"]
)
TASK_DURATION = Histogram(
    "celery_task_duration_seconds", "Task duration", ["task_name"]
)
CPU_USAGE = Gauge(
    "celery_process_cpu_percent", "CPU usage percentage", ["task_name", "worker_id"]
)
MEMORY_USAGE = Gauge(
    "celery_process_memory_mb", "Memory usage in MB", ["task_name", "worker_id"]
)
